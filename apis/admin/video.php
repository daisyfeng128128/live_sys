...
if($_GET['active']=='del'){
	...
	operational_log(5,"删除首页视频上传id,{$id}",$_REQUEST);
	$msg = "操作成功";
}
...
$sql = "select DISTINCT * from video ORDER BY id desc {$where_limit}";
$sql_count = "select count(*) from video";
...
<table width="99%" align="center" cellspacing="1" cellpadding="3" class="i_table">
    <tbody>
	<tr><td class="head" colspan="18"><b>视频列表</b></td></tr>
	<tr><td colspan="18">
	
		 <a href="video_edit.php"><span class="tal_01_01"></span><span class="tal_01_02">添加内容</span><span class="tal_01_03"></span></a><br>
	   </td></tr>
	<tr class="head_1">
	<td>编号</td>
	<td>标题</td>
	...
	<td>操作</td>
		...
		<td><a href="video_edit.php?id=<?php echo $v["id"]?>">编辑</a>&nbsp;
