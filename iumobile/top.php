...
group by s.userid ");
		//$show = $db->GetArray("SELECT a.userid,a.usernumber,a.nickname,a.totalpoint,a.totalcost FROM `user` a,`applysign` b WHERE a.userid=b.userid and b.pass=1 and a.clanid=$clanid");
		$userids = null;
		foreach($show as $k=>$v){
