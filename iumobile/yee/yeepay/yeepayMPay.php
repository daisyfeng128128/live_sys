...
//	正式环境API请求基础地址
	 ...
	 * @return string
	 */
	public function webPay($order_id,$transtime,$amount,$product_catalog,$identity_id,$identity_type,$user_ip,$callbackurl='',$fcallbackurl='',$currency=156,$product_name='',$product_desc='',$other=''){
		$query = array(
			'orderid'	=>	$order_id,
			'transtime'	=>	$transtime,
			'currency'	=>	$currency,
	 ...
	 * @return string
	 */
	public function creditWebPay($order_id,$transtime,$amount,$product_catalog,$identity_id,$identity_type,$user_ip,$callbackurl='',$fcallbackurl='',$currency=156,$product_name='',$product_desc='',$other=''){
		$query = array(
			'orderid'	=>	$order_id,
			'transtime'	=>	$transtime,
			'currency'	=>	$currency,
		...
		return $this->getUrl(YEEPAY_MOBILE_API, 'bankcard/credit/request', $query);
	}
	 ...
	 * @return string
	 */
	public function debitWebPay($order_id,$transtime,$amount,$product_catalog,$identity_id,$identity_type,$user_ip,$callbackurl='',$fcallbackurl='',$currency=156,$product_name='',$product_desc='',$other=''){
		$query = array(
			'orderid'	=>	$order_id,
			'transtime'	=>	$transtime,
			'currency'	=>	$currency,
		...
		return $this->getUrl(YEEPAY_MOBILE_API, 'bankcard/debit/request', $query);
	}
