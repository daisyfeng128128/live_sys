...
<head lang="en">
    ...
    <script src="/public/ipview/js/ipview.js"></script>
...
<div class="nav-left">
    <div class="live-logo" style="width:70px;height:82px;background:url(/skin/logo_zhibojian.png) no-repeat;position: absolute;top:8px;left:2px">
        <a style="width:54px;height:32px;display: inline-block" href="/index_qqgame.php"  ></a>
    </div>
                ...
                <div class="infoBox" style="display:none">
                    <div class="mt-right">
                        ...
                        <div class="mt-rl3">
                            ...
                            <span class="mt-charge"><a  href="/pay">充值</a></span>
                        </div>
                    </div>
                </div>
                <div class="ospan"><a href="/centeros"  > <img src="<?php echo _IMAGES_DOMAIN_.'/'.$user[avatar]?>" alt="<?php echo $user["nickname"]?>"></a></div>
            </div>
        </div>
