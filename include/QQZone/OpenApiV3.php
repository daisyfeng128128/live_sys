...
require_once $app_path.'include/QQZone/lib/SnsNetwork.php';
require_once $app_path.'include/QQZone/lib/SnsSigCheck.php';
require_once $app_path.'include/QQZone/lib/SnsStat.php';
