 ...
 */
require_once $app_path.'include/Zend_Mail/Mail/Transport/Abstract.php';

/**
 * @see Zend_Mime
 */
require_once $app_path.'include/Zend_Mail/Mime.php';

/**
 * @see Zend_Mime_Message
 */
require_once $app_path.'include/Zend_Mail/Mime/Message.php';

/**
 * @see Zend_Mime_Part
 */
require_once $app_path.'include/Zend_Mail/Mime/Part.php';
    ...
    public function send($transport = null)
    {
        ...
        if ($transport === null) {
            if (! self::$_defaultTransport instanceof Zend_Mail_Transport_Abstract) {
                require_once $app_path.'include/Zend_Mail/Mail/Transport/Sendmail.php';
