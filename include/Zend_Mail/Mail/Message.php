 ...
 * Zend_Mail_Part
 */
require_once $app_path.'include/Zend_Mail/Mail/Part.php';

/**
 * Zend_Mail_Message_Interface
 */
require_once $app_path.'include/Zend_Mail/Mail/Message/Interface.php';
        ...
        if (isset($params['file'])) {
            if (!is_resource($params['file'])) {
                ...
                if ($params['raw'] === false) {
                     ...
                     */
                    require_once $app_path.'include/Zend_Mail/Mail/Exception.php';
