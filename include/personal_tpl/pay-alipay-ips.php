			...
			<div class="mb_content">
				...
				<div class="rec_ob_zfb rec_info" style="display: block;">
					...
					<div class="choose_bank">
						<p style="display:none">支付银行：</p>
						<ul id="bankName" style="display:none">
...
$(".btn_porange").click(function(){
	...
	if(pgname=='rec_ob_zfb'){//银行充值
		...
		bankid=0;
		url+="?chooseuserid="+chooseuserid+"&p3_Amt="+cash+"&paychannel=2&pd_FrpId="+bankid+"&agentid="+agentid+"&showuserid="+showuserid;
	}
