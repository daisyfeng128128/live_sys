...
<?php endif;?>
				...
				<ul class="recharge_menu" id="recmenu">
					<li class="txt rec2 hightlight" data-rel="rec_wxpay">微信支付</li>
				</ul>
			</div>
		</div>
		<!--右边加载区域-->
		<div id="mall_content">
			...
			<div class="mb_content">
				...
				<!--微信充值-->
				<div class="rec_wxpay rec_info" style="display: block;">
					<div class="base_info">
					<!--文字提示-->	
						<p class="p1" style="margin-top:10px;">当前充值方式：<span class="colorfo">微信充值</span></p>
						<p>请选择充值金额：

								<input type="radio" name="zhifutype_wxpay" value="1" checked="checked" onchange="selectRmbwxpay()">
								...
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="zhifutype_wxpay" value="2" onchange="$('#zhifupalRmbex_wxpay').blur()">&nbsp;其他金额&nbsp;&nbsp;<input type="text" id="zhifupalRmbex_wxpay" class="intBd input180 " style="width:90px">元
							</p>
