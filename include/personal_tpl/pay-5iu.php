...
<?php endif;?>
				...
				<ul class="recharge_menu" id="recmenu"><li class="rec1 icon_rec hightlight" data-rel="rec_ob_zfb"></li>
					<li class="rec2 icon_rec" data-rel="rec_zfb"></li>
...
$(".btn_porange").click(function(){
	...
	if(pgname=='rec_ob_zfb'){//银行充值
		...
		url+="?chooseuserid="+chooseuserid+"&p3_Amt="+cash+"&paychannel=1&pd_FrpId="+bankid+"&agentid="+agentid;
	}
		...
		url+="?chooseuserid="+chooseuserid+"&p3_Amt="+cash+"&paychannel=2&agentid="+agentid;
	}
		...
		url+="?chooseuserid="+chooseuserid+"&p3_Amt="+$("#selectRmb3").val()+"&paychannel=3&pd_FrpId="+bankid+"&ifid=15&agentid="+agentid;
	}
		...
		if(data_value=="10"){//神州行充值卡
			var bankid="SZX-NET";
			url+="?chooseuserid="+chooseuserid+"&p3_Amt="+$("#selectRmb1").val()+"&paychannel=4&pd_FrpId="+bankid+"&ifid=1&agentid="+agentid;
		}else if(data_value=="15"){//中国联通充值卡
			var bankid="UNICOM-NET";
			url+="?chooseuserid="+chooseuserid+"&p3_Amt="+$("#selectRmb1").val()+"&paychannel=5&pd_FrpId="+bankid+"&ifid=2&agentid="+agentid;
		}
	}
...
// $db->debug =true;
	...
	if(!empty($aid)){
?>
agentid=<?php echo $aid["userid"]?>;
$('#addProxy').html('<label>代理：</label><span id="ppNickName" class="fblod"><?php echo $aid["nickname"]?></span> <a style="color:#FF6C00;font-size:14px" onclick="agentid=0;this.parentNode.style.display=\'none\';this.parentNode.innerHTML=\'\';">取消</a>').show();
<?php }}?>
selectRmb2();
selectRmb5();
selectRmb();
