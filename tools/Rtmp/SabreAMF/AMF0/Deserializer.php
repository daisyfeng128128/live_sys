<?php
    ...
    require_once $rtmp_app_path.'SabreAMF/AMF0/Const.php';
    require_once $rtmp_app_path.'SabreAMF/Const.php';
    require_once $rtmp_app_path.'SabreAMF/Deserializer.php';
    require_once $rtmp_app_path.'SabreAMF/AMF3/Deserializer.php';
    require_once $rtmp_app_path.'SabreAMF/AMF3/Wrapper.php';
    require_once $rtmp_app_path.'SabreAMF/TypedObject.php';
