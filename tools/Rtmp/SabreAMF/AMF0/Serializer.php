<?php
    ...
    require_once $rtmp_app_path.'SabreAMF/AMF3/Const.php';
    require_once $rtmp_app_path.'SabreAMF/Const.php';
    require_once $rtmp_app_path.'SabreAMF/Serializer.php';
    require_once $rtmp_app_path.'SabreAMF/AMF3/Serializer.php';
    require_once $rtmp_app_path.'SabreAMF/AMF3/Wrapper.php';
    require_once $rtmp_app_path.'SabreAMF/ITypedObject.php';
