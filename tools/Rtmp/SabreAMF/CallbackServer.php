<?php
    ...
    require_once $rtmp_app_path.'SabreAMF/Server.php';
    require_once $rtmp_app_path.'SabreAMF/AMF3/AbstractMessage.php';
    require_once $rtmp_app_path.'SabreAMF/AMF3/AcknowledgeMessage.php';
    require_once $rtmp_app_path.'SabreAMF/AMF3/RemotingMessage.php';
    require_once $rtmp_app_path.'SabreAMF/AMF3/CommandMessage.php';
    require_once $rtmp_app_path.'SabreAMF/AMF3/ErrorMessage.php';
    require_once $rtmp_app_path.'SabreAMF/DetailException.php';
