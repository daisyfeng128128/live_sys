<?php
    ...
    require_once $rtmp_app_path.'SabreAMF/OutputStream.php';
    require_once $rtmp_app_path.'SabreAMF/InputStream.php';
    require_once $rtmp_app_path.'SabreAMF/Message.php';
    require_once $rtmp_app_path.'SabreAMF/Const.php';
    require_once $rtmp_app_path.'SabreAMF/InvalidAMFException.php';
