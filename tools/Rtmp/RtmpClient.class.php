<?php
$rtmp_app_path=str_replace('RtmpClient.class.php','',__FILE__);
//print_r($rtmp_app_path);exit;

require $rtmp_app_path."RtmpPacket.class.php";
require $rtmp_app_path."RtmpStream.class.php";
require $rtmp_app_path."RtmpMessage.class.php";
require $rtmp_app_path."RtmpOperation.class.php";
require $rtmp_app_path."RtmpSocket.class.php";
