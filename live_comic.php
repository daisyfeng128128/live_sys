...
<head lang="en">
    ...
    <script src="<?php echo $page_var['cdn_domain']?>/js/sea-modules/<?php echo _dbds_;php?>/anchor-base.js?v=<?php echo $vsn;?>"></script>
    ...
    <script src="<?php echo $page_var['cdn_domain']?>/js/sea-modules/swfobject/swfobject.js?v=<?php echo $vsn;?>"></script>
    ...
    <link href="<?php echo $page_var['cdn_domain']?>/skin/public/public.css?v=<?php echo $vsn;?>" rel="stylesheet" type="text/css"/>
    ...
    <script type="text/javascript">
        var UIF = {
            ...
            init : function(){
                seajs.config({
                    base : "/js/sea-modules/<?php echo _dbds_;php?>/",
                    alias : {
                ...
                seajs.use("/js/sea-modules/<?php echo _dbds_;php?>/anchor-webs",function(W){
                    UIF.handler = new W();
...
<div class="nav-left">
    <div class="live-logo" style="width:70px;height:82px;background:url(/skin/logo_zhibojian.png) no-repeat;position: absolute;top:8px;left:2px">
        <a style="width:54px;height:32px;display: inline-block" href="/" target="_blank"></a>
    </div>
    <?php if(!$user){ ?>
                ...
                <div class="infoBox" style="display:none">
                    <div class="mt-right">
                        ...
                        <div class="mt-rl3">
                            ...
                            <span class="mt-charge"><a target="_blank" href="/pay">充值</a></span>
                            <span class="nl-login-out"><a href="/login.php?action=logout&amp;type=html">退出</a></span>
                        </div>
                    </div>
                </div>
                <div class="ospan"><a href="/centeros" target="_blank"> <img src="<?php echo _IMAGES_DOMAIN_.'/'.$user[avatar]?>" alt="<?php echo $user["nickname"]?>"></a></div>
            </div>
        </div>
    <?php }?>
    <div class="nl-nav">
