		...
		success:function(data){
			...
			if (data.info.state == 1) {
				...
				$('.header-notice').hover(function(){
					$(this).css('background','url(public/index/images/header_notice_hover.png) no-repeat');
				},function(){
					$(this).css('background','url(public/index/images/header_notice.png) no-repeat');
				});	
			}else{
				//console.log('有未读消息');
				$('.header-notice').css({'background':'url(public/index/images/icon_xiaoxi.png) no-repeat','margin-top':'17px'});
