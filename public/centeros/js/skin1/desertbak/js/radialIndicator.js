...
;(function ($, window, document) {
    ...
    Indicator.prototype = {
        ...
        value: function (val) {
            ...
            ctx.beginPath();
            ctx.arc(center, center, indOption.radius, -(quart), -((circ) * perVal / 100) - quart, true);
    ...
    radialIndicator.defaults = {
        radius: 47, //inner radius of indicator
        barWidth: 5, //bar width
        barBgColor: '#223748', //unfilled bar color
        barColor: '#ABE9FE', //filled bar color , can be a range also having different colors on different value like {0 : "#ccc", 50 : '#333', 100: '#000'}
